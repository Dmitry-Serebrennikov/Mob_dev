    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Integer i = 0; i < cards.size(); i++){
            for (Integer j = 0; j < cards.get(i).size(); j++){
                ...
                //Log.d("mytag", i.toString() + " " + j.toString() + " " + cards.get(i).get(j).isDeleted);
            }
        }
        if(checkWin()) {
                    ...
                    if (openedCard == 1 && c != openedCardList.get(0) && !c.isDeleted) {
                        ...
                        if (c.flip(x, y)) {
                            ...
                            if (openedCardList.get(0).color == openedCardList.get(1).color) {
                                ...
                                //Log.d("TAG", openedCardList.get(0).isDeleted + " " + openedCardList.get(1).isDeleted);
                                //Log.d("TAG1", c.isDeleted.toString());
                            }
                            else {
